...
def show_combined_graph(epochs, loss_history, loss_history_validation, accuracy_history, accuracy_history_validation):
    ...
    try:
        ...
        # Loss subplot.
        ax_loss.plot(epochs_graph, loss_history, label="training loss")
        ax_loss.plot(epochs_graph, loss_history_validation, label="validation loss")
        ...
        # Accuracy subplot.
        ax_acc.plot(epochs_graph, accuracy_history, label="training accuracy")
        ax_acc.plot(epochs_graph, accuracy_history_validation, label="validation accuracy")
